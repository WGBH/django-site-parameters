...
class BaseTimeStampModel(models.Model):
    ...
    date_modified = models.DateTimeField(_('Last Updated'), auto_now=True)
...
class BaseOrderedModel(models.Model):
    order_in_list = models.PositiveIntegerField(_('Order in List'), null=False, default=0)
...
class BaseControlledVocabulary(BaseGenericStatusModel, BaseTimeStampModel, BaseTitleModel,
                               BaseSlugModel):
    class Meta:
        abstract = True
